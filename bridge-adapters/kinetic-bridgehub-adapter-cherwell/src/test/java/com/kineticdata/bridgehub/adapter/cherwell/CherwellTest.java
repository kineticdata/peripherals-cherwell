...
public class CherwellTest extends BridgeAdapterTestBase {
     ...
     * request.setFields(fields);
     * request.
     * setQuery("GetTotal=<%=parameter[\"Get Total\"]%>&xUser=<%=parameter[\"X-User\"]%>"
     * );
     * 
     * Map parameters = new HashMap();
     * parameters.put("Get Total", "false");
     * parameters.put("X-User",
     * "{\"UserName\":\"kineticadmin1@kinetic.com\",\"PrimaryContactID\":104903,\"CCWebUserID\":3346,\"DisplayName\":\"Admin1, Kinetic \",\"TimeZoneCode\":35,\"IsPrimary\":false,\"ContactID\":237647,\"UserType\":\"Administrator\",\"CID\":\"DDX\"}"
     * );
     * request.setParameters(parameters);
     * 
     * Count count = null;
     ...
     * assertTrue(list.getRecords().get(0).getValue("$.Contact.ContactID").equals(
     * Long.valueOf(16245)));
     * }
     * 
     * @Test
     ...
     * list.getRecords().get(0).getRecord().get("FirstName");
     * 
     ...
     * assertNull(error);
     * assertTrue(list.getRecords().size() > 0);
     * assertTrue(!firstName.equals((String)
     * list.getRecords().get(0).getRecord().get("FirstName")));
     * 
     ...
     * request.setFields(fields);
     * request.
     * setQuery("id=<%=parameter[\"Contact ID\"]%>&xUser=<%=parameter[\"X-User\"]%>"
     * );
     * Map parameters = new HashMap();
     ...
     * request.
     * setQuery("/contact/<%=parameter[\"Contact ID\"]%>?accessor=Data & xUser=<%=parameter[\"X-User\"]%>"
     * );
     * 
     ...
     * request.setStructure("Adhoc");
     * request.
     * setQuery("/contact?accessor=Data&GetTotal=<%=parameter[\"Get Total\"]%>"
     * + "&xUser=<%=parameter[\"X-User\"]%>");
     ...
     * 
     * assertNull(error);
     * assertTrue(list.getRecords().get(0).getRecord().get("ContactID").equals(
     * adhocList.getRecords().get(0).getRecord().get("ContactID")));
     * 
     * metadata.remove("next_page");
     * metadata.remove("count");
     * request.setStructure("Contact");
     ...
     * 
     * assertNull(error);
     * assertFalse(list.getRecords().get(0).getRecord().get("ContactID").equals(
     * listTwo.getRecords().get(0).getRecord().get("ContactID")));
     * 
     * request.setStructure("Adhoc");
     * request.
     * setQuery("/contact?accessor=Data&GetTotal=<%=parameter[\"Get Total\"]%>"
     ...
     * 
     * assertNull(error);
     * assertFalse(adhocList.getRecords().get(0).getRecord().get("ContactID").equals
     * (adhocListTwo.getRecords().get(0).getRecord().get("ContactID")));
     * assertTrue(listTwo.getRecords().get(0).getRecord().get("ContactID").equals(
     * adhocListTwo.getRecords().get(0).getRecord().get("ContactID")));
     * }
     * 
     * @Test
     ...
     * request.setStructure("Adhoc");
     * request.
     * setQuery("/contact?accessor=Data&GetTotal=<%=parameter[\"Get Total\"]%> & xUser=<%=parameter[\"X-User\"]%>"
     * );
     * 
     * RecordList adhocList = null;
     * try {
